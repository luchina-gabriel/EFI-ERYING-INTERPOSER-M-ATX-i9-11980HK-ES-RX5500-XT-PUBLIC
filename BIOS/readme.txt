...
- AFUWINx64 5.14.02.0026
- AFUWINGUIx64 5.14.02.0026
- AFU User Guide
...
- /PFRU           Updates platform firmware.(*2)
- /PFRU:CPLD      Updates platform firmware.(*2)
- /PFRA           Signal active image update intent.(*2)
- /PFRD           Signal dynamic region update of active image.(*2)
- /PFRR           Signal recovery image update intent.(*2)
- /PFRC           Signal CPLD update intent.(*2)
- /PFRW           Wait until reset to update.(*2)
